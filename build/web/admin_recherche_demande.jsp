<%-- 
    Document   : admin_recherche_demande
    Created on : 13 juin 2013, 14:29:55
    Author     : ayoub
--%>
...
<html>
    <head>
        ...
        <title>page de recherche demande pour admin</title>
    </head> 
    <body>
        <%  
        String critere=(String)request.getParameter("critere");
           ...
           {
           listdem=dh.DemandesByDate(valeur1,valeur2); 
           }
           
           else 
               listdem=dh.DemandesBy(critere,valeur1);
            
           %>
           <h3>Nombre de Demandes Trouvées : <%= listdem.size() %></h3>
         <table class="data"> 
            <TR class="data"> 
